...
const UpdateAssets = () => {
    ...
    const getAssetsData = () => {
        ...
        axios({
            ...
            console.log(err);
            toast(err?.response?.data?.message || t("Failed to get asset data"), {
                type: "error",
                theme: "light",
                position: "top-right"
            });
    ...
    const handleUpdateAssets = (data) => {
        ...
        axios({
            ...
            toast(res?.data?.message || t("assets update successfully"), {
                type: "success",
                theme: "light",
                position: "top-right"
            });
            ...
            toast(err?.response?.data?.errors?.[0]?.message ?? err?.response?.data?.message ?? t("Failed to add assets"), {
                type: "error",
                theme: "light",
                position: "top-right"
            });
                                                ...
                                                <div className="d-flex align-items-center gap-2 flex-wrap">
                                                    {oldDocument ?
                                                        <div className="d-flex align-items-center gap-2">
                                                            ...
                                                            <div className="eye">
                                                                <a target="_blank" href={oldDocument} className='button align-self-end yellow p-1 rounded-circle'>
