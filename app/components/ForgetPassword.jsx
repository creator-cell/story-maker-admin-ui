            ...
            <div className="container">
                <div className="row justify-content-center align-items-center">
                    <div className="col-lg-5 col-md-5 col-12 d-lg-flex d-md-flex d-none">
                        <Image src={'/images/forget.svg'} width={400} height={400} alt="forget password"/>    
                    </div>
                                ...
                                <form action={handleSubmit(handleForgotPassword)} className="row justify-content-center needs-validation" noValidate="">
                                    <div className="col-lg-12 col-md-12 col-12">
                                        <div className="mb-input">
                                            <input type="email" className="form-control" placeholder="Email address *" value={watch("email")}
                                            {...register("email",{
                                                required : {
                                                    value: true,
                                    ...
                                    <div className="col-lg-12 col-md-12 col-12 mb-2">
                                        <CustomLink className="text-end" href={'/login'}><i className="fa fa-arrow-left"></i> Back to Login</CustomLink>
                                    </div>
                                    <div className="col-lg-12 col-md-12 col-12">
